              ...
              <div className="panel-edit" id="salary" onClick={() => this.toggleElement('salary')}>
                ...
                <ul className="panel panel-edit-list">
                  ...
                  <li
                    ...
                    data-keyvalue="2500"
                  >Change to base salary</li>
                  <li
                    className="panel-edit-item js-panel-item"
                    data-keytitle="Hourly salary"
                    data-keyvalue="25"
                  >Change to hourly salary</li>
                  <li
                    className="panel-edit-item js-panel-item"
                    data-keytitle="MRP low"
                    data-keyvalue="1220"
                  >Change to MRP low</li>
                  <li
                    className="panel-edit-item js-panel-item"
                    data-keytitle="MRP"
                    data-keyvalue="1900"
              ...
              <ul className="box-headings">
                <li className="box-heading active">
                  <div className="box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.78 43">
                      <title>Zasób 1</title><path
                  ...
                  <ul className="box-actions">
                    ...
                    <li>
                      <a title="Help">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><circle
                          cx="25"
                          cy="25"
                          r="24"
                          fill="none"
                          ...
                          strokeMiterlimit="10"
                          strokeWidth="2"
                        /><rect width="50" height="50" fill="none" /><path
                      ...
                      <div className="toggler-content">
                        <table className="table table--stripes">
                          <tbody>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Middle Name:</span>
                              </td>
                              <td>Text</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Display Name:</span>
                              </td>
                              <td>Text</td>
                            </tr>
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Formal Name:</span>
                              </td>
                              <td>Text</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Marital Status</span>
                              </td>
                              <td>
                                <select className="custom-select">
                                  <option value="v-1">Drop-down</option>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Marital Status Since:</span>
                              </td>
                              <td>Date</td>
                            </tr>
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Second Nationality:</span>
                              </td>
                              <td>
                                <select className="custom-select">
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Third Nationality:</span>
                              </td>
                              <td>
                                <select className="custom-select">
                                  <option value="v-1">Drop-down for ISO Country Code</option>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Native Preferred Language:</span>
                              </td>
                              <td>
                                <select className="custom-select">
                                  <option value="v-1">Drop-down for ISO Country Code</option>
                            ...
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Challenge Status:</span>
                              </td>
                              <td>Text</td>
                            </tr>
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Certificate Start Date:</span>
                              </td>
                              <td>Date</td>
                            </tr>
                            <tr>
                              <td className="table-align">
                                <span className="table-label">Certificate End Date:</span>
                              </td>
                              <td>Date</td>
                            </tr>
                          </tbody>
                        ...
                        <div className="toggler-content-inner">
                          ...
                          <table className="table table--stripes">
                            <tbody>
                              <tr>
                                <td className="table-align">
                                  <span className="table-label">Ethnic Group:</span>
                                </td>
                                <td>
                                  <select className="custom-select">
                                    <option value="v-1">Drop-down</option>
                              ...
                              <tr>
                                <td className="table-align">
                                  <span className="table-label">Challenged Veteran:</span>
                                </td>
                                <td>
                                  <select className="custom-select">
                                    <option value="v-1">Drop-down</option>
                          ...
                          <div className="toggler-content">
                            <table className="table table--stripes">
                              <tbody>
                                ...
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Country of Birth</span>
                                  </td>
                                  <td>
                                    <select className="custom-select">
                                      <option value="v-1">Drop-down</option>
                                ...
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Region of Birth</span>
                                  </td>
                                  <td>Text</td>
                                </tr>
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Date of Death</span>
                                  </td>
                                  <td>Date</td>
                                </tr>
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Employee Id</span>
                                  </td>
                                  <td>Text</td>
                                </tr>
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Employee Global Id</span>
                                  </td>
                                  <td>Text</td>
                                </tr>
                              </tbody>
                        ...
                        <div className="js-scrollbar">
                          <table className="table">
                            <tbody>
                              <tr>
                                <td>
                                  <span className="table-label">Company Manager:</span>
                                </td>
                                <td>manager</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Cmp Mgr Of Cmp Mgr:</span>
                                </td>
                                <td>comManager</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Mgr Operational:</span>
                                </td>
                                <td>manager</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Op Mgr Of Op Mgr:</span>
                                </td>
                                <td>opManager</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Mgr Functional:</span>
                                </td>
                                <td>FunManager</td>
                              </tr>
                              <tr>
                      ...
                      <div className="box-inner box-inner--no-pad">
                        <table className="table">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="table-label">Contact Person Name:</span>
                              </td>
                              <td>madhu</td>
                            </tr>
                            <tr>
              ...
              <div className="col-xs-12 col-md-6">
                <div className="box">
                  <ul className="box-headings js-tabs">
                    <li className="box-heading active">
                      <div className="box-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.52 43">
                          <title>Zasób 5</title><path
                          ...
                          <div className="toggler-content">
                            <table className="table table--stripes">
                              <tbody>
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Address Type:</span>
                                  </td>
                                  <td>
                                    <select className="custom-select">
                                      <option value="v-1">Drop-Down (Home Address / Mailing Address)</option>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Address Line 1</span>
                                  </td>
                                  <td>Text</td>
                                </tr>
                                <tr>
                                  <td className="table-align">
                                    <span className="table-label">Address Line 2</span>
                                  </td>
                                  <td>Text</td>
                                </tr>
                                <tr>
                        ...
                        <div className="js-scrollbar">
                          <table className="table">
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <span className="table-label">Org Op Level3:</span>
                                </td>
                                <td>level3</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Org Op Level2:</span>
                                </td>
                                <td>level2</td>
                              </tr>
                              <tr>
                                <td>
                                  <span className="table-label">Org Op Level1:</span>
                                </td>
                                <td>level1</td>
                              </tr>
                            </tbody>
              ...
              <div className="col-xs-12">
                <div className="box">
                  <ul className="box-headings js-tabs">
                    <li className="box-heading active">
                      <div className="box-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.46 43">
                          <title>Zasób 6</title><path
              ...
              <div className="col-xs-12">
                <div className="box">
                  <ul className="box-headings js-tabs">
                    <li className="box-heading active">
                      <div className="box-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.93 43">
                          <title>Zasób 7</title><polygon
